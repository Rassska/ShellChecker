...
**As you can see, all corner cases have tested and at the same we can check the reason of the cases which was falled. The file _error.txt_ has this information**
